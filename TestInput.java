...
public class TestInput{
  ...
  public static void main(String[] args){
    //datatyp variableName = expression
    //1. It can only start with a letter, _, or $
    ...
    */
    ...
    final double PI_VALUE = 3.1415; //constants are all capital
                                    //multipls words separated by underscores
    ...
    age = input.nextInt(); //.nestInt() is for int types
    ...
    /*
      ...
      * multiplication
      ...
      (), exponents, multiplaction OR division, addition OR subtraction
      from left to right
